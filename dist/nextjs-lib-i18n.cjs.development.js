...
var _Link = _interopDefault(require('next/link'));
  ...
  function I18Next(supportedLocales, deafultLocale) {
    ...
    this.useChangeLocale = function () {
      ...
      var handleChange = function handleChange(locale) {
        var localeOmmitedPath = getLocaleOmmitedPath(router$1.asPath, _this.supportedLocales);
        var as = "/" + locale + localeOmmitedPath;
        router$1.push(router$1.pathname, as);
      };
    ...
    this.useLocaleCanonicalPath = function (_temp) {
      ...
      if (currentLanguage === _this.deafultLocale && !reserveDefaultLocalePath) {
        path = getLocaleOmmitedPath(router$1.asPath, _this.supportedLocales);
      } else {
        if (!getMatchLocaleByPath(router$1.asPath, _this.supportedLocales)) {
          path = "/" + currentLanguage + router$1.asPath;
        } else {
          path = router$1.asPath;
        }
      }
    ...
    this.changeLanguage = /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(language) {
        return runtime_1.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                return _context.abrupt("return", new Promise(function (res, rej) {
                  i18next.changeLanguage(language, function (error, t) {
                    if (error) rej(error);else res(t);
                  });
                }));
    ...
    this.useResource = function (resource) {
      ...
      var useTranslationFn = reactI18next.useTranslation(resource[ResourceSymbol]).t;
    ...
    this.createResource = function (resource) {
      ...
      Object.entries(resource).forEach(function (_ref3) {
        var lng = _ref3[0],
            keyValue = _ref3[1];
...
var LocaleProvider = function LocaleProvider(_ref) {
  ...
  var locale = React.useMemo(function () {
    ...
    else return (_getMatchLocaleByPath = getMatchLocaleByPath(router$1.asPath, i18n.supportedLocales)) != null ? _getMatchLocaleByPath : initialLocale;
  }, [router$1]);
...
exports._LocaleProvider = _LocaleProvider;
exports.getAllViableLocaleRegex = getAllViableLocaleRegex;
exports.getLocaleFromAppContext = getLocaleFromAppContext;
exports.getLocaleOmmitedPath = getLocaleOmmitedPath;
exports.getLocaleOmmitedUrl = getLocaleOmmitedUrl;
exports.getMatchLocaleByPath = getMatchLocaleByPath;
exports.getNormalizeTralingSlashPath = getNormalizeTralingSlashPath;
exports.localeParser = localeParser;
//# sourceMappingURL=nextjs-lib-i18n.cjs.development.js.map
